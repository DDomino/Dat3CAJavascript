...
public class NewServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print("Connection: "+request.getHeader("connection"));
            out.print("cache-control: "+request.getHeader("cache-control"));
            out.print("accept: "+request.getHeader("accept"));
            out.print("user-agent: "+request.getHeader("user-agent"));
            out.print("accept-encodig: "+request.getHeader("accept-encodig"));
